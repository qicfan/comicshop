...
<div class="box">
  ...
  <div class="zx_zc">
	...
	<a href="<?=URL?>index.php/front/usercomment/ucommentShow?gid=<?php echo $goodsid;?>&type=0" />
	<?php if($type==0){?><span class="normaltab">商品评论</span><?php }else{ ?><span class="hovertab">商品评论</span><?php }?></a>
	<a href="<?=URL?>index.php/front/usercomment/ucommentShow?gid=<?php echo $goodsid;?>&type=1" />
	<?php if($type==1){?><span class="normaltab">好评</span><?php }else{ ?><span class="hovertab">好评</span><?php }?></a>
	<a href="<?=URL?>index.php/front/usercomment/ucommentShow?gid=<?php echo $goodsid;?>&type=2" />
	<?php if($type==2){?><span class="normaltab">中评</span><?php }else{ ?><span class="hovertab">中评</span><?php }?></a>
	<a href="<?=URL?>index.php/front/usercomment/ucommentShow?gid=<?php echo $goodsid;?>&type=3" />
	<?php if($type==3){?><span class="normaltab">差评</span><?php }else{ ?><span class="hovertab">差评</span><?php }?></a>
	</div>
  ...
  <div class="zx_yc">
	...
	<a href="<?=URL?>index.php/front/usercomment/normalCommentShow?gid=<?php echo $goodsid;?>" /><span class="normaltab">中评</span></a>
	<a href="<?=URL?>index.php/front/usercomment/badCommentShow?gid=<?php echo $goodsid;?>" /><span class="hovertab">差评</span></a>
	 </div>
...
<div class="pl">
          ...
          <div class="pl_y">
            ...
            <div class="hf"><span class="right">有0人认为此评论有用</span><a href="<?=URL?>index.php/front/usercomment/comment_replyAdd?cid=<?php echo $goodscomment['comment']["$i"]['comment']->id;?>&gid=<?=$goodscomment['comment']["$i"]['comment']->goodsid;?>">回复(<?=$commentreplycount["$i"];?>)</a></div>
			<?php 
