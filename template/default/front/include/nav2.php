...
<div class="nav2">
  <span class="title2"><a href="<?=URL?>">首页</a> <?=$navigation?></span>
  <div class="kjfs">
	<span class="order" style="cursor:pointer;" onmouseover="cartBrief()" >我的购物车</span>
	<span style="cursor:pointer;"><img src="<?=URL?>media/img/front/niu1.gif"/></span>
	<span class="go"><a href="<?=URL?>index.php/front/cart/cartSelect" style="color:black;">去结算</a></span>
  </div>
