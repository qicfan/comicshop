...
<body>
  ...
  <ul id="container">
    <li id="header">
      <h1>统计中心</h1>
      <div class="link"></div>
      <div id="desc">商品人气</div>
    </li>
    <li id="tips">
      <a href="<?=URL?>index.php/admin/tongji/click">按点击次数排序</a>
       | <a href="<?=URL?>index.php/admin/tongji/click?sort=1">按收藏次数排序</a>
       | <a href="<?=URL?>index.php/admin/tongji/click?sort=2">按评论次数排序</a>
    </li>
<li>
...
<tr>
	...
	<?=$v->goodsname?></td>
	<td width="200"><?=$v->viewcount?></td>    
    <td width="200"><?=$v->storecount?></td>
    <td width="200"><?=$v->commentcount?></td>
</tr>
<?php
}
?>
