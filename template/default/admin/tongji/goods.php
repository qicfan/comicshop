...
<tr>
	...
	<?=$v->goodsname?></td>
    <td width="200"><span style="color:green; font-weight:bold"><?=$v->sum?></span></td>
    <td width="200"><?=$v->goods_sn?></td>
    <td width="200">￥<?=$v->shoppirce?></td>
    <td width="200">￥<?=($v->shoppirce)*($v->sum)?></td>
</tr>
<?php
}
?>
